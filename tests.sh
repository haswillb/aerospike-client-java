...
time ./benchmarks/run_benchmarks -h 192.168.99.100 -k 10000 -t 100000  -w RU,50

echo "BIG TEST 50% read update 50% 1,000,000 keys 1,000,000 transactions"
time ./benchmarks/run_benchmarks -h 192.168.99.100 -k 1000000 -t 1000000  -w RU,50

echo "BIGER TEST 50% read update 50% 20,000,000 keys 2,000,000 transactions"
time ./benchmarks/run_benchmarks -h 192.168.99.100 -k 20000000 -t 2000000  -w RU,50
